...
public class GuiMenuHorse extends GuiMenu{
    ...
    public GuiMenuHorse(Player player){
        ...
        addItem(new GuiItemHorseColor(this, x1++, 1, Material.CLAY_BRICK, (short) 0, Horse.Color.DARK_BROWN));
        ...
        addItem(new GuiItemHorseArmor(this, x3++, 3, Material.IRON_BARDING, "iron"));
        addItem(new GuiItemHorseArmor(this, x3++, 3, Material.GOLD_BARDING, "gold"));
        addItem(new GuiItemHorseArmor(this, x3, 3, Material.DIAMOND_BARDING, "diamond"));
